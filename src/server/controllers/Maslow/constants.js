...
export const MASLOW_REALTIME_COMMANDS = [
    '~', // Cycle Start
    '!', // Feed Hold
    '?', // Current Status
    '\x18' // Reset Maslow (Ctrl-X)
];

// https://github.com/grbl/grbl/wiki/Configuring-Maslow-v0.9
// http://linuxcnc.org/docs/html/gcode/overview.html#cap:modal-groups
export const MASLOW_MODAL_GROUPS = [
...
export const MASLOW_SETTINGS = [
    ...
    },
    {
        ...
        units: 'millimeters',
        description: 'Sets how fast Maslow travels through consecutive motions. Lower value slows it down.'
    },
    {
        setting: '$12',
