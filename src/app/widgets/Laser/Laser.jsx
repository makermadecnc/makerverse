    ...
    return (
      <div>
        <div className="form-group">
          <label className="control-label">{i18n._("Laser Mode")}</label>
          <div className="row no-gutters">
            <Toggler
              className="clearfix"
              onToggle={() => {
                this.workspace.controller.command(
                  "gcode",
                  `$32=${
                    this.workspace.controller.settings["$32"].value === "1"
                      ? "0"
                      : "1"
                  }`
                );
          ...
          //Goes here $32=1 on $32=0 off this.workspace.controller.command("",)
          //this.workspace.controller.settings
