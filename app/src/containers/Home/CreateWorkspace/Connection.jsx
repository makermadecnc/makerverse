...
class Connection extends PureComponent {
  ...
  renderPortOption = (option) => {
    ...
    return (
      <div style={styles.option} title={label}>
        ...
        {manufacturer && <i>{i18n._('Manufacturer: {{manufacturer}}', { manufacturer })}</i>}
      </div>
    );
  };
  ...
  render() {
    const { connectionStatus, disabled, isLoading, handleRefreshPorts } = this.props;
          ...
          <div className='input-group input-group-sm'>
            ...
            <div className='input-group-btn'>
              <button
                ...
                disabled={disabled}>
                <i className={cx('fa', 'fa-refresh', { 'fa-spin': isLoading })} />
              </button>
            </div>
            <div className='input-group-btn'>
              <button
