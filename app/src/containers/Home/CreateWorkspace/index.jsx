...
import { submitMachineProfileSuggestion } from 'lib/ows/machines';
  ...
  actions = {
    ...
    handleCreateWorkspace: (workspaceSettings) => {
      ...
      this.actions
        ...
        .catch((res) => {
          const err = res.body && res.body.msg ? res.body.msg : i18n._('An unexpected error has occurred.');
          this.setState({
  ...
  render() {
    ...
    return (
      <Widget className={styles.widgetWide}>
        <Widget.Header>
          <Widget.Title>{i18n._('New Workspace')}</Widget.Title>
          <Widget.Controls>
            <Widget.Button
        ...
        <Widget.Content className={classNames(styles['widget-content'], { [styles.hidden]: state.minimized })}>
