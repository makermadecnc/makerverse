...
import { Button, ButtonGroup, ButtonToolbar } from 'components-old/Buttons';
import api from 'api';
import { WORKFLOW_STATE_IDLE } from 'constants/index';
      ...
      <div style={style} className={classNames(className, styles.workspace)}>
        ...
        {blockingText && (
          <div className={styles.mask}>
            <div className={styles.maskOverlay}>{blockingText}</div>
          </div>
        )}
      </div>
    );
