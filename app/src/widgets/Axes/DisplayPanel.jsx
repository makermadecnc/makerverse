...
import { AXIS_E, AXIS_X, AXIS_Y, AXIS_Z, AXIS_A, AXIS_B, AXIS_C, IMPERIAL_UNITS, METRIC_UNITS } from '../../constants';
...
class DisplayPanel extends PureComponent {
  ...
  renderTaskbarFeature = (featureKey, title, icon, disabled, action) => {
    ...
    return feature ? (
      <TaskbarButton disabled={disabled} onClick={action}>
        <Tooltip placement='bottom' content={i18n._(feature.title)} disabled={disabled} hideOnClick>
  ...
  renderAxis = (axis) => {
    ...
    return (
      <tr>
          ...
          <Taskbar style={{ minHeight: '27px' }}>
            <div className='clearfix'>
              <div className='pull-right'>
                {this.renderTaskbarFeature(
                  `mpos_set_home_${axisKey}`,
                  `Set machine's ${axisLabel} position to zero`,
                  iconPin,
                  !canZeroOutMachine,
                  () => {
                ...
                {this.renderTaskbarFeature(
                  `mpos_go_home_${axisKey}`,
                  `Home the ${axisLabel} axis`,
                  iconHome,
                  !canHomeMachine,
                  () => {
          ...
          <Taskbar style={{ minHeight: '27px' }}>
            <div className='clearfix'>
              <div className='pull-right'>
                ...
                {this.renderTaskbarFeature(
                  `wpos_set_home_${axisKey}`,
                  `Set the work position's ${axisLabel} axis to zero`,
                  iconPin,
                  !canZeroOutWorkOffsets,
                  () => {
        ...
        <td className={styles.action}>{renderActionDropdown({ wcs })}</td>
      </tr>
    );
  };
        ...
        <table className='table-bordered'>
          <thead>
            <tr>
              ...
              <th className={styles.action}>{this.renderActionDropdown({ wcs })}</th>
            </tr>
          </thead>
          <tbody>
