...
class MaslowPanels extends PureComponent {
  ...
  render() {
    ...
    return (
      <div>
        {positionError && (
          <ToastNotification style={{ marginBottom: '10px' }} type='warning' dismissible={false}>
            The Maslow cannot find its position. Calibration may have been corrupted.
            <Button btnSize='medium' btnStyle='flat' onClick={(event) => this.reset()}>
        ...
        <Panel className={styles.panel}>
          <Panel.Heading className={styles['panel-heading']}>
            <Toggler
              ...
              <Toggler.Icon className='pull-right' expanded={panel.settings.expanded} />
            </Toggler>
          </Panel.Heading>
          {panel.settings.expanded && (
            <Panel.Body>
              <span style={{ fontStyle: 'italic' }}>Hover over setting names for information.</span>
              <hr style={{ marginTop: '10px', marginBottom: '10px' }} />
          ...
          {panel.statusReports.expanded && (
            <Panel.Body>
              <div className='row no-gutters'>
                ...
                <div className='col col-xs-8'>
                  <div className={styles.well}>{activeState}</div>
                </div>
              </div>
              <div className='row no-gutters'>
                <div className='col col-xs-4'>
        ...
        <Panel className={styles.panel}>
          <Panel.Heading className={styles['panel-heading']}>
            <Toggler
              ...
              <Toggler.Icon className='pull-right' expanded={panel.about.expanded} />
            </Toggler>
          </Panel.Heading>
            ...
            <Panel.Body>
              {this.workspace.hardware.hasFirmware && (
                <div className='row no-gutters'>
                  ...
                  <div className='col col-xs-8'>
                    <div className={styles.well}>{this.workspace.hardware.firmwareStr}</div>
                  </div>
                </div>
              )}
              {this.workspace.hardware.hasProtocol && (
                <div className='row no-gutters'>
                  ...
                  <div className='col col-xs-8'>
                    <div className={styles.well}>{this.workspace.hardware.protocolStr}</div>
                  </div>
                </div>
              )}
              {this.workspace.hardware.hasPlainVersion && (
                <div className='row no-gutters'>
                  ...
                  <div className='col col-xs-8'>
                    <div className={styles.well}>{this.workspace.hardware.versionStr}</div>
                  </div>
                </div>
              )}
            </Panel.Body>
