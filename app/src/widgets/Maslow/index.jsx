...
import { MASLOW } from '../../constants';
import { MODAL_NONE, MODAL_CONTROLLER, MODAL_CALIBRATION, MODAL_ONBOARDING } from './constants';
...
class MaslowWidget extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const canOpenModal = shouldOnboard && !this.state.modal.startedOnboarding && this.state.modal.name === MODAL_NONE;
        ...
        {isReady && (
          <Widget.Content className={classNames(styles['widget-content'], { [styles.hidden]: minimized })}>
            ...
            {state.modal.name === MODAL_ONBOARDING && (
              <OnboardingModal workspaceId={this.workspace.id} state={state} actions={actions} />
            )}
            <MaslowPanels workspaceId={this.workspace.id} state={state} actions={actions} />
          </Widget.Content>
        )}
      </Widget>
    );
