...
import { Button, ButtonToolbar, ButtonGroup } from 'components-old/Buttons';
...
class SecondaryToolbar extends PureComponent {
  static propTypes = {
    ...
    cameraMode: PropTypes.oneOf([CAMERA_MODE_PAN, CAMERA_MODE_ROTATE]),
