...
class GridLine {
  ...
  constructor(isImperial, axes) {
    ...
    axes.x.eachGridLine((xPos, isMajor) => {
      ...
      geometry.vertices.push(new THREE.Vector3(xPos, axes.y.min, 0), new THREE.Vector3(xPos, axes.y.max, 0));
    ...
    axes.y.eachGridLine((yPos, isMajor) => {
      ...
      geometry.vertices.push(new THREE.Vector3(axes.x.min, yPos, 0), new THREE.Vector3(axes.x.max, yPos, 0));
      geometry.colors.push(colorGrid, colorGrid);
