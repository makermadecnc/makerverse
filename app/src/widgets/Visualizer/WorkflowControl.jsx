...
class WorkflowControl extends PureComponent {
  ...
  renderButtonFeature(key, title, desc, icon, btnType, disabled) {
    ...
    return !feature ? (
      ...
      <Tooltip placement='bottom' style={{ color: '#fff' }} content={i18n._(feature.description)} disabled={!!disabled}>
        <button
          type='button'
  ...
  render() {
    ...
    return (
      <div className={styles.workflowControl}>
        ...
        <div className='btn-toolbar'>
          <div className='btn-group btn-group-sm'>
            ...
            <Dropdown id='upload-dropdown'>
              ...
              <Dropdown.Menu>
                <Dropdown.Item header>{i18n._('Watch Directory')}</Dropdown.Item>
                <Dropdown.Item
                  onSelect={() => {
          ...
          <div className='btn-group btn-group-sm'>
            ...
            {isWorkflowActive &&
              ...
              this.renderButtonFeature(
                'stop',
                null,
                'Stop program execution (progress will be lost)',
                'fa-stop',
                'danger',
                !hasPausedWorkflow,
              )}
          ...
          <div className='btn-group btn-group-sm'>
            {activeState.isIdle &&
              this.renderButtonFeature('sleep', 'Sleep', 'Put machine to sleep', 'fa-bed', 'success')}
            {(activeState.hasAlarm || hasError) &&
              this.renderButtonFeature(
                'unlock',
                'Unlock',
                'Clear system alarms and errors',
                'fa-unlock-alt',
                'warning',
              )}
        ...
        <AlertErrorToast workspaceId={this.workspace.id} />
      </div>
    );
  }
}
