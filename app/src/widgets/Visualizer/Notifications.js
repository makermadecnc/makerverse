  ...
  <div
    ...
    <ToastNotification
      ...
      {type === NOTIFICATION_M0_PROGRAM_PAUSE && (
        <div>
          <div>
            <strong>{i18n._('M0 Program Pause')}</strong>
          </div>
          <div>{i18n._('Click the Resume button to resume program execution.')}</div>
        </div>
      )}
      {type === NOTIFICATION_M1_PROGRAM_PAUSE && (
        <div>
          <div>
            <strong>{i18n._('M1 Program Pause')}</strong>
          </div>
          <div>{i18n._('Click the Resume button to resume program execution.')}</div>
        </div>
      )}
      {type === NOTIFICATION_M2_PROGRAM_END && (
        <div>
          <div>
            <strong>{i18n._('M2 Program End')}</strong>
          </div>
      ...
      {type === NOTIFICATION_M30_PROGRAM_END && (
        <div>
          <div>
            <strong>{i18n._('M30 Program End')}</strong>
          </div>
          <div>{i18n._('Click the Stop button to stop program execution.')}</div>
        </div>
      )}
      {type === NOTIFICATION_M6_TOOL_CHANGE && (
        <div>
          <div>
            <strong>{i18n._('M6 Tool Change')}</strong>
          </div>
          <div>
            {i18n._(
            ...
            <Space width='4' />
            <Anchor target='_blank' href='https://github.com/cncjs/cncjs/wiki/Tool-Change'>
              {i18n._('Learn more')}
            </Anchor>
          </div>
        </div>
